            ...
            "enumerations": [
                {
                    ...
                    "values": [{"name": "value1", "value": 1}, {"name": "value2", "value": 2}],
                }
            ],
            "notifications": [],
            "requests": [],
            "structures": [{"name": "Structure1", "properties": []}],
            "typeAliases": [],
        }
    )
    ...
    model = MetaModel.from_json(
        {
            ...
            "structures": [{"name": "Structure1", "properties": []}],
            "typeAliases": [
                {"name": "TypeAlias1", "type": {"kind": "reference", "name": "Structure1"}}
            ],
        }
    )
    ...
    model = MetaModel.from_json(
        {
            ...
            "structures": [],
            "typeAliases": [
                {"name": "TypeAlias1", "type": {"kind": "reference", "name": "TypeAlias2"}},
                {"name": "TypeAlias2", "type": {"kind": "reference", "name": "TypeAlias1"}},
            ],
        }
    )
...
def get_test_default_names() -> Dict[str, Any]:
    import gen.static._lsp_enum as lsp_enum
    import gen.static._util as util
...
def get_anytype_test_model() -> Dict[str, JSON_VALUE]:
    return {
        ...
        "structures": [
            {
                "name": "TestBaseString",
                "properties": [{"name": "test", "type": {"kind": "base", "name": "string"}}],
            },
            {
                "name": "TestBaseInteger",
                "properties": [{"name": "test", "type": {"kind": "base", "name": "integer"}}],
            },
            {
            ...
            },
            {
                ...
                "properties": [
                    {
                        "name": "test",
                        "type": {"kind": "array", "element": {"kind": "base", "name": "integer"}},
                    }
                ],
            },
            {
            ...
            {
                "name": "Part1",
                "properties": [{"name": "part1", "type": {"kind": "base", "name": "integer"}}],
            },
            {
                "name": "Part2",
                "properties": [{"name": "part2", "type": {"kind": "base", "name": "boolean"}}],
            },
            {
                "name": "TestAnd",
                "properties": [
                    {
                        ...
                        "type": {
                            "kind": "and",
                            "items": [
                                {"kind": "reference", "name": "Part1"},
                                {"kind": "reference", "name": "Part2"},
                            ],
                        },
                    }
                ],
                ...
                "properties": [
                    {
                        ...
                        "type": {
                            ...
                            "value": {
                                "properties": [
                                    {"name": "sub", "type": {"kind": "base", "name": "string"}}
                                ]
                            },
                        },
                    }
            ...
            },
            {
                ...
                "properties": [
                    {"name": "test", "type": {"kind": "stringLiteral", "value": "test123"}}
                ],
            },
            {
                "name": "TestIntegerLiteral",
                "properties": [{"name": "test", "type": {"kind": "integerLiteral", "value": 4096}}],
            },
            {
                "name": "TestBooleanLiteral",
                "properties": [{"name": "test", "type": {"kind": "booleanLiteral", "value": True}}],
            },
        ],
        "typeAliases": [],
    }
    ...
    model = MetaModel.from_json(
        {
            ...
            "structures": [
                {
                    "name": "Test1",
                    "extends": [{"kind": "reference", "name": "Test2"}],
                    "mixins": [{"kind": "reference", "name": "Test3"}],
                    "properties": [
                        {"name": "test1", "type": {"kind": "base", "name": "string"}},
                        {
                            "name": "testopt",
                ...
                {
                    "name": "Test2",
                    "properties": [{"name": "test2", "type": {"kind": "base", "name": "integer"}}],
                },
                {
                    "name": "Test3",
                    "properties": [{"name": "test3", "type": {"kind": "base", "name": "boolean"}}],
                },
                {
                    "name": "Test4",
                    "properties": [
            ...
            "structures": [
                {
                    "name": "Root",
                    "properties": [
                        {"name": "testReference", "type": {"kind": "reference", "name": "Test1"}},
                        {
                            "name": "testArray",
                            "type": {
                                "kind": "array",
                                "element": {"kind": "reference", "name": "Test2"},
                            },
                        },
                        {
                            "name": "testMap",
                            "type": {
                                "kind": "map",
                                "key": {"kind": "reference", "name": "TestTypeAlias"},
                                "value": {"kind": "reference", "name": "Test3"},
                            },
                        },
                        {
                            "name": "testOr",
                            "type": {
                                "kind": "or",
                                "items": [{"kind": "reference", "name": "Test4"}],
                            },
                        },
                        {
                            "name": "testTuple",
                            "type": {
                                "kind": "tuple",
                                "items": [{"kind": "reference", "name": "Test5"}],
                            },
                        },
                    ],
                },
                ...
                {"name": "Test4", "properties": []},
                {"name": "Test5", "properties": []},
                {"name": "ShouldNotShowUp", "properties": []},
            ],
            "typeAliases": [{"name": "TestTypeAlias", "type": {"kind": "base", "name": "string"}}],
        }
    )
    generator = Generator(model)
            ...
            "enumerations": [
                {
                    ...
                    "type": {"kind": "base", "name": "string"},
                    "values": [
                        {"name": "testStr1", "value": "Hello"},
                        {"name": "testStr2", "value": "World"},
                    ],
                },
                {
                    "name": "TestEnum2",
                    ...
                    "values": [
                        {"name": "testInt1", "value": 11},
                        {"name": "testInt2", "value": 22},
                    ],
                },
            ],
            "notifications": [],
...
def test_generator_server_capabilities() -> None:
    model = MetaModel.from_json(
        {
            "requests": [],
            "structures": [
                {"name": "DocumentSelector", "properties": []},
                    ...
                    "properties": [
                        {
                            ...
                            "type": {"kind": "reference", "name": "DocumentSelector"},
                        }
                    ],
                },
                {
                    "name": "StaticRegistrationOptions",
                    "properties": [{"name": "id", "type": {"kind": "base", "name": "string"}}],
                },
                {
                    ...
                    "properties": [
                        ...
                        {
                            "name": "capability2",
                            "type": {"kind": "reference", "name": "StaticRegistrationOptions"},
                        },
                        {
                            "name": "capability3",
                            "type": {
    ...
    server_capabilities = names["ServerCapabilities"].from_json(
        {
            "capability1": {"documentSelector": {}},
            "capability2": {"id": "test_id"},
            "capability3": {"test": True},
        }
    )
...
def test_generator_feature_registration() -> None:
    model = MetaModel.from_json(
        {
            ...
            "structures": [
                ...
                {"name": "ServerCapabilities", "properties": []},
            ],
            "typeAliases": [
                {
                    "name": "LSPAny",
                ...
                {
                    "name": "LSPArray",
                    "type": {"kind": "array", "element": {"kind": "reference", "name": "LSPAny"}},
                },
                {
                    "name": "LSPObject",
                    "type": {
                        "kind": "map",
                        "key": {"kind": "base", "name": "string"},
                        "value": {"kind": "reference", "name": "LSPAny"},
                    },
                },
            ],
            "enumerations": [],
    ...
    registration2 = eval(
        "Registration(id='test_id/2', method='test', registerOptions={'id': 'test_id/3'})", names
    )
