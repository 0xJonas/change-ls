...
write_request_result: Dict[str, Callable[[Any], JSON_VALUE]] = {
    ...
    "textDocument/prepareRename": lambda p: write_or_type(p, (lambda i : (isinstance(i, Range)) or (isinstance(i, AnonymousStructure37)) or (isinstance(i, AnonymousStructure38)), lambda i : i is None), (lambda i: write_PrepareRenameResult(i), lambda i: i)),
