...
@pytest.mark.test_sequence(
    "test/text_document/test_semantic_tokens_enrich_multiple_semantic_tokens_per_syntactic_token.json"
)
async def test_semantic_tokens_enrich_multiple_semantic_tokens_per_syntactic_token(
    mock_document_1: TextDocument,
) -> None:
    await mock_document_1.load_tokens("enrich")
...
@pytest.mark.test_sequence(
    "test/text_document/test_semantic_tokens_enrich_nested_semantic_tokens.json"
)
